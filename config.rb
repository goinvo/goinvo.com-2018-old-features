...
activate :s3_sync do |s3_sync|
  s3_sync.bucket                     = 'goinvo-stage' # The name of the S3 bucket you are targetting. This is globally unique.
...
activate :s3_redirect do |config|
  config.bucket                = 'goinvo-stage' # The name of the S3 bucket you are targetting. This is globally unique.
