		    ...
		    if (this.checked){
			    ...
			    if (id == "obesity") {
			    	if($(".tab-pane.active").attr("id") == "1")
			    		$(".tab-pane.active .profile.desktop .row:first-child img").attr("src", "/old/images/features/careplans/isabella_obese.png");
			    	if($(".tab-pane.active").attr("id") == "2")
			    		$(".tab-pane.active .profile.desktop .row:first-child img").attr("src", "/old/images/features/careplans/reggie_obese.png");
			    	if($(".tab-pane.active").attr("id") == "3")
			    		$(".tab-pane.active .profile.desktop .row:first-child img").attr("src", "/old/images/features/careplans/donna_obese.png");
			    }
			}
			else {
				...
				if (id == "obesity") {
			    	if($(".tab-pane.active").attr("id") == "1")
			    		$(".tab-pane.active .profile.desktop .row:first-child img").attr("src", "/old/images/features/careplans/isabella_norm.png");
			    	if($(".tab-pane.active").attr("id") == "2")
			    		$(".tab-pane.active .profile.desktop .row:first-child img").attr("src", "/old/images/features/careplans/reggie_norm.png");
			    	if($(".tab-pane.active").attr("id") == "3")
			    		$(".tab-pane.active .profile.desktop .row:first-child img").attr("src", "/old/images/features/careplans/donna_norm.png");
			    }
			}
	    }
	    else {
