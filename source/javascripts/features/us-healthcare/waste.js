$(document).ready(function () {
  ...
  d3.csv("/features/us-healthcare/data/data-waste.csv", function (error, data) {
    ...
    rectangles.on('mouseover', function (d) {
      ...
      tooltip
        .html("<strong>" + d.Procedure + "</strong>" + "<br>" + "<div class = 'tt-important'>" + d3.format("%")(d.Unnecessary / d.NumberProcedures) + "</div> Nonrecommended <br><div class = 'tt-important'>" + d3.format("$,")(d.Waste) + "</div> Wasted");
      ...
      tooltip.style("left", function (d) {
        ...
        .style("top", parseFloat(me.attr('y')) - 60 + "px");
